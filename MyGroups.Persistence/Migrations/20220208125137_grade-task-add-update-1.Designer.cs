...
namespace MyGroups.Persistence.Migrations
{
    ...
    [Migration("20220208125137_grade-task-add-update-1")]
    partial class gradetaskaddupdate1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyGroups.Domain.Models.Grades.GradesTasks", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("ComletedTaskId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ComletedTaskId");

                    b.HasIndex("GradeId");

                    b.ToTable("GradesTasks");
                });
            ...
            modelBuilder.Entity("MyGroups.Domain.Models.Grades.Grade", b =>
                {
                    ...
                    b.HasOne("MyGroups.Domain.Models.Tasks.CompletedTask", "CompletedTask")
                        .WithOne("Grade")
                        .HasForeignKey("MyGroups.Domain.Models.Grades.Grade", "Id")
            ...
            modelBuilder.Entity("MyGroups.Domain.Models.Grades.GradesTasks", b =>
                {
                    b.HasOne("MyGroups.Domain.Models.Tasks.CompletedTask", "ComletedTask")
                        .WithMany()
                        .HasForeignKey("ComletedTaskId");

                    b.HasOne("MyGroups.Domain.Models.Grades.Grade", "Grade")
                        .WithMany()
                        .HasForeignKey("GradeId");

                    b.Navigation("ComletedTask");
